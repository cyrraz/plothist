...
latex_documents = [
    (master_doc, 'plothist.tex', 'plothist Documentation',
     'Cyrille Praz, Tristan Fillinger', 'manual'),
]
...
man_pages = [
    (master_doc, 'plothist', 'plothist Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'plothist', 'plothist Documentation',
     author, 'plothist', 'One line description of project.',
     'Miscellaneous'),
]
