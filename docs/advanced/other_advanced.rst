...
This example shows how to plot an asymmetry plot between two histograms and two functions. Information on how to convert a function from different fitting library to an object that can be used by ``plothist`` can be found here :ref:`plot-fit-result-label`.
