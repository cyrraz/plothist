...
for style in ["plothist", "matplotlib"]:
    ...
    hist_0, bins, _ = ax1.hist(df['variable_0'], bins=20, histtype="step", linewidth=1.2, label='h1')
    hist_1 = ax1.hist(df['variable_1'], bins=bins, histtype="step", linewidth=1.2, label='h2')
